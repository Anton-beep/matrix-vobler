...
(*поле ввода, в которое необходимо написать адрес сервера выделено красным прямоугольником*)
    ...
    <img src="assets/images/find-account-provider.png" alt="Find account provider">
...
8. Заполните поля для регистрации аккаунта:
    ...
    ***⚠️ ВНИМАНИЕ! Если вы забудете пароль от вашего аккаунта его будет НЕВОЗМОЖНО восстановить (вообще никак). Запишите пароль и храните его в надёжном месте.***
